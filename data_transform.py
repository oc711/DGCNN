...
with codecs.open('./data/all_schemas_me.json', 'w', encoding='utf-8') as f:
...
with codecs.open('./data/data_train_me.json', 'w', encoding='utf-8') as f:
...
with codecs.open('./data/data_test_me.json', 'w', encoding='utf-8') as f:
